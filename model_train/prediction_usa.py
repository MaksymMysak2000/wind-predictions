...
def four_hour_prediction(model, X, y, title, start, end):
    ...
    for i in range(0, end - start - 1):
        ...
        wind_speed = round(l[0], 2)
        # wind_speed = l[0].toFixed
        # if (i < 1):
        #     wind_speed -= 4.0
        # else:
...
model_lsmt = load_model('C:/Users/Maksym_Mysak/PycharmProjects/diploma/LSTM_model')
model_cnn = load_model('C:/Users/Maksym_Mysak/PycharmProjects/diploma/CNN_model')
model_gru = load_model('C:/Users/Maksym_Mysak/PycharmProjects/diploma/GRU_model')
